  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      doc.font('Helvetica').fontSize(9).fillColor(mutedText)
        .text('This certificate was generated by FurrCircle and is for informational purposes only.', 50, footerY + 16, { align: 'center', width: doc.page.width - 100 });
      doc.font('Helvetica').fontSize(9).fillColor(mutedText)
        .text('furrcircle.app', 50, footerY + 34, { align: 'center', width: doc.page.width - 100 });
