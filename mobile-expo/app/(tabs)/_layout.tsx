...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="community" options={{ title: "Community", tabBarIcon: ({ color, size }) => <Users color={color} size={size} />, tabBarBadge: chatUnreadCount > 0 ? chatUnreadCount : undefined }} />
