  ...
  return (
    <footer className="bg-[url('/curveBg.svg')] bg-cover bg-top bg-no-repeat relative pt-32 pb-12">
      <div className="container mx-auto px-10">
        ...
        <div className="border-t border-black/5 pt-8 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[#666666] text-[13px]">
            © {new Date().getFullYear()} Rhinon Tech. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link href={"/web/privacy-policy" as any} className="text-[#666666] text-[13px] hover:text-[#987D6B] transition-colors">
              Privacy Policy
            </Link>
          </div>
        </div>
