...
export default function PrivacyPolicyPage() {
  return (
    <main className="flex-1 bg-[#fffbf5] pt-12 pb-24">
      <section className="mx-auto max-w-4xl px-6 pt-16 pb-12 sm:px-8 lg:px-10">
        <p className="mb-4 text-sm font-bold uppercase tracking-[0.08em] text-[#987D6B]">
          Privacy Policy
        </p>
        <h1 className="max-w-3xl text-4xl font-extrabold leading-tight text-[#1A1A1A] sm:text-5xl">
      ...
      <section className="border-t border-gray-200 bg-[#fffbf5]">
        <div className="mx-auto max-w-4xl px-6 py-16 sm:px-8 lg:px-10">
          <div className="space-y-12">
            {sections.map((section) => (
              <section key={section.title}>
                ...
                <ul className="mt-5 space-y-4 text-base leading-8 text-gray-600">
                  {section.points.map((point) => (
                    <li key={point} className="flex gap-3">
                      <span className="mt-3 h-1.5 w-1.5 shrink-0 rounded-full bg-[#987D6B]" />
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
          ...
          <section className="mt-14 border-t border-gray-200 pt-10">
            <h2 className="text-2xl font-bold text-[#1A1A1A] sm:text-3xl">Contact Us</h2>
            <p className="mt-5 text-base leading-8 text-gray-600">
              ...
              <a
                ...
                className="text-[#987D6B] underline underline-offset-4"
              >
